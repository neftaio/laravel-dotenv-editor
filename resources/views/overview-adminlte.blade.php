                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                            aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title">{!! __('dotenv-editor::views.overview_edit_modal_title') !!}
                                    </h4>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="editvalue">{!! __('dotenv-editor::views.overview_edit_modal_value')
                                            !!}</label>
...
<script>
    new Vue({
        ...
        data: {
            ...
            alertmessage: '',
            views: [{
                    name: "{{ __('dotenv-editor::views.overview') }}",
                    active: 1
                },
                {
                    name: "{{ __('dotenv-editor::views.addnew') }}",
                    active: 0
                },
                {
                    name: "{{ __('dotenv-editor::views.backups') }}",
                    active: 0
                },
                {
                    name: "{{ __('dotenv-editor::views.upload') }}",
                    active: 0
                }
            ],
            newEntry: {
                ...
                $.ajax({
                    ...
                    success: function () {
                        vm.showAlert('success',
                            "{{ __('dotenv-editor::views.backup_created') }}");
                    }
                })
            },
